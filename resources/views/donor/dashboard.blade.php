...
<body class="bg-gray-100 min-h-screen flex">
    <aside class="w-64 bg-white shadow-lg border-r border-gray-200">
        <div class="p-6">
            <a href="{{ route('donor.dashboard') }}" class="text-2xl font-bold text-blue-600">
                EduFund
            </a>
        </div>
        <nav class="px-4 space-y-2">
            <a href="{{ route('donor.dashboard') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-md bg-blue-50 text-blue-600">
    ...
    <div class="flex-1 flex flex-col">
        <header class="bg-white shadow-sm border-b border-gray-200 p-4 flex items-center justify-between">
            <h1 class="text-xl font-semibold text-gray-800">Donor Dashboard</h1>
