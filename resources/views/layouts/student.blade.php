    ...
    <div class="flex-1 flex flex-col">
        <header class="bg-surface shadow-sm border-b border-neutral-200 p-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <img src="{{ auth()->user()->studentProfile?->avatar_url ?? asset('images/default-avatar.svg') }}" alt="Profile" class="w-10 h-10 rounded-full object-cover border border-neutral-200">
