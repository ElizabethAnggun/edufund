    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-surface p-6 rounded-xl border border-neutral-200 hover-lift">
                ...
                <p class="text-3xl font-bold text-neutral-900">${{ number_format($stats['total_raised'] ?? 0, 2) }}</p>
            </div>
            ...
            <div class="bg-surface p-6 rounded-xl border border-neutral-200 hover-lift">
                ...
                <p class="text-sm text-neutral-500 mb-1">Total Disbursed</p>
                <p class="text-3xl font-bold text-neutral-900">${{ number_format($stats['total_disbursed'] ?? 0, 2) }}</p>
                <a href="{{ route('school.disbursements.index') }}" class="text-sm text-primary hover:text-primary-hover font-medium mt-2 inline-block">View Disbursements</a>
            </div>
        </div>
