...
@section('content')
    <div class="animate-fade-in-up">
        <div class="text-center mb-8">
            ...
            <p class="text-neutral-500">Create a new password for your account</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-6">
                <label for="password_confirmation" class="block text-neutral-700 text-sm font-medium mb-2">Confirm New Password</label>
