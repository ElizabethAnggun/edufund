...
@section('content')
    <h2 class="text-2xl font-bold text-center text-neutral-900 mb-6">Register</h2>

    <form method="POST" action="{{ route('register.post') }}">
        @csrf

        <div class="mb-4">
            <label for="name" class="block text-neutral-700 text-sm font-medium mb-2">Full Name</label>
        ...
        <div class="mb-4">
            <label for="role" class="block text-neutral-700 text-sm font-medium mb-2">Role</label>
    ...
    <p class="mt-6 text-center text-neutral-600">
        Already have an account? <a href="{{ route('login') }}" class="text-primary hover:text-primary-hover font-medium transition-colors">Login</a>
    </p>
@endsection
