...
@section('testimonial-title', 'Start Your Education Journey')
@section('testimonial-text', 'Join thousands of students, schools, and donors who are transforming education funding through blockchain technology. Transparent, secure, and accessible for everyone.')
@section('testimonial-name', 'EduFund Community')
@section('testimonial-role', 'Decentralized Education Platform')

@section('content')
    <div class="animate-fade-in-up">
        <!-- Tab Navigation -->
        <div class="flex mb-8 bg-neutral-100 rounded-full p-1 relative">
            <div id="tab-indicator" class="absolute top-1 bottom-1 bg-white rounded-full shadow-sm transition-all duration-300" style="left: calc(50% + 4px); right: 4px;"></div>
            <button onclick="showLogin()" id="login-tab" class="flex-1 py-2.5 text-sm font-semibold text-neutral-500 relative z-10 transition-colors">Login</button>
            <button onclick="showRegister()" id="register-tab" class="flex-1 py-2.5 text-sm font-semibold text-neutral-900 relative z-10 transition-colors">Register</button>
        </div>
